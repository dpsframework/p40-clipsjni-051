...
extern "C" {
#endif
#undef net_sf_clipsrules_jni_Environment_CLIPSJNI_LOAD
#define net_sf_clipsrules_jni_Environment_CLIPSJNI_LOAD 0L
#undef net_sf_clipsrules_jni_Environment_CLIPSJNI_LOADLIBRARY
#define net_sf_clipsrules_jni_Environment_CLIPSJNI_LOADLIBRARY 1L
